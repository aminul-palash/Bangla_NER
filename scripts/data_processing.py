...
# def merged_json_data(output_path = "merged_data.json"):
#     ob = IobToJSONbiluo()
#     data1 = ob.convert_iob_to_biluo(file_path = "all_data.txt")

#     obj = JsonlTobiluo()  
#     data2 = obj.convert_jsonl_to_biluo_json_format(file_path = "main.jsonl")
#     data = data1 + data2
#     print("merged_data_length : ",len(data))
#     with open(output_path, 'w') as fp:
#         json.dump(data, fp, indent=2, ensure_ascii=False)
#         print(f"File saved at: {output_path}")

def merge_bliou_json_files(iob_data_path,BNER_data_path,jsonl_data_path,output_path = "data/merged_data.json"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("BNER_data_path", type=str, help="Path to the IOB data file")
...
# python data_processing.py all_data.txt main.jsonl
